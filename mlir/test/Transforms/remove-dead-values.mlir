...
// RUN: mlir-opt %s -remove-dead-values -canonicalize -split-input-file | FileCheck %s --check-prefix=CHECK-CANONICALIZE
...
// CHECK-CANONICALIZE-DAG:     %[[c5:.*]] = arith.constant 5 : i32
// CHECK-CANONICALIZE-DAG:     %[[p0:.*]] = ub.poison : i32
